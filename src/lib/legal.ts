...
export const PRIVACY_PARAGRAPHS = [
  ...
  "Email preferences: performance digests are optional — set them to daily, weekly, or monthly, or switch all non-essential email off entirely, in Settings.",
  "Your rights: you can view and edit your information in Settings at any time, export your campaign data on request, and delete your account yourself from Settings — deletion permanently removes your personal data from our systems.",
